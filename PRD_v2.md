# Product Requirements Document — Version 2.0 (frozen snapshot)
...
**Living document:** [PRD.md](PRD.md) — edit in place for v2.1 and later. **This file** is the frozen **PRD v2.0** baseline for reference and sign-off.
...
*This file is the frozen **PRD v2.0** snapshot (April 2026). For the latest requirements, use [PRD.md](PRD.md).*
